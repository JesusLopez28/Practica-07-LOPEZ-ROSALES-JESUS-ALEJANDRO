...
public class FormMostrarAlumnos extends javax.swing.JFrame {
    ...
    public FormMostrarAlumnos(FormMenu menu, PilaAlumnos lista) {
        initComponents();
        principal = menu;
        listaAlumnos = lista;
        txtResultado.setText(listaAlumnos.recorrerPila());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMostrarAlumnos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
